...
/*        statement.executeUpdate("insert into operator(id, name, address, fee) values" +
        ...
        /*statement.executeUpdate("insert into phone_book(number, abonent_id, registered_date) values" +
                "((select number from operator_number where operator_id = 3), 2, '2019-11-30 14:55:56'), " +
                "((select number from operator_number where operator_id = 5), 3, '2019-12-30 14:55:56')");*/

        statement.executeUpdate("insert into phone_book(number, abonent_id, registered_date) values" +
                "('380475564823', 5, '2019-11-30 14:55:56'), " +
                "('380495672004', 6, '2019-12-30 14:55:56')");
